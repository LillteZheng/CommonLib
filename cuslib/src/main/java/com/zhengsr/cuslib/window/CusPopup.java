...
public  class CusPopup implements PopupWindow.OnDismissListener {
    private static final String TAG = "CusPopup";
    private PopupWindow mPopupWindow;
    private View contentview;
    private Context mContext;
    private Activity mActivity;
    public CusPopup(Builder builder) {
    ...
    public <T extends View> T getViewbyId(int viewid){
        if (mPopupWindow != null){
            return (T)this.contentview.findViewById(viewid);
        }
        return null;
    }
    /**
     ...
     * @return
     */
    public CusPopup showAtLocation(int rootviewid, int gravity, int x, int y){
        if (mPopupWindow != null){
     ...
     * @return
     */
    public CusPopup showAsLaction(int targetviewId, int gravity, int offx, int offy){
        if (mPopupWindow != null){
     ...
     * @return
     */
    public CusPopup showAsLaction(View targetview, int gravity, int offx, int offy){
        if (mPopupWindow != null){
            mPopupWindow.showAsDropDown(targetview,offx,offy,gravity);
        }
        return this;
    ...
    public static class Builder{
       ...
       public Builder setContext(Context context){
        ...
        public Builder setLayoutId(int contentviewid){
        ...
        public Builder setOutSideDimiss(boolean outsidecancel){
        ...
        public CusPopup builder(){
           return new CusPopup(this);
        }
    }
}